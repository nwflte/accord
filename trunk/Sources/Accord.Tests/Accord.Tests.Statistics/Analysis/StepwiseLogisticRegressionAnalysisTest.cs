...
namespace Accord.Tests.Statistics
{
    ...
    public class StepwiseLogisticRegressionAnalysisTest
    {
        ...
        public void ComputeTest()
        {
            ...
            Assert.AreEqual(0.10115178966846869, full.Coefficients[0].OddsRatio);
            Assert.AreEqual(1.0071560349008841, full.Coefficients[1].OddsRatio);
            Assert.AreEqual(35.498643454320685, full.Coefficients[2].OddsRatio);

            Assert.AreEqual(1.8621025559858235, full.Coefficients[0].StandardError);
            Assert.AreEqual(0.030965622111482096, full.Coefficients[1].StandardError);
            Assert.AreEqual(1.3272612173685281, full.Coefficients[2].StandardError);
